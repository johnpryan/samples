...
Lg:function Lg(a){this.a=a},
Sd:function(a,b){return Math.max(H.y(a),H.y(b))},
...
if(this.qv(c))this.i6(H.ws(b,c,"draw-rect",m.c),new P.I(Math.min(H.y(b.a),H.y(b.c)),Math.min(H.y(b.b),H.y(b.d))),c)
else{m.gaP().ez(c,b)
s=c.b
m.gL(m).beginPath()
r=m.gaP().ch
...
H.R2(s.style,a6)
this.i6(s,new P.I(Math.min(H.y(a0),H.y(a2)),Math.min(H.y(a1),H.y(a3))),a7)}else{a4.gaP().ez(a7,new P.a2(a0,a1,a2,a3))
r=a7.b
q=a4.gaP().ch
p=a4.gL(a4)
if(q==null)a0=a6
...
d.i6(H.ws(m,c,"draw-rect",s.c),new P.I(Math.min(H.y(m.a),H.y(m.c)),Math.min(H.y(m.b),H.y(m.d))),c)
return}l=q.nO()
...
p+=b.ib(k)
q=Math.max(q,H.y(b.ia(k)))}a2=n.ao$}j=Math.max(0,(a1?a0:0)-p)
if(r>0){i=a1?j/r:0/0
a2=b.by$
for(h=0;a2!=null;){g={}
n=a2.d
...
p+=b.ib(k)
h+=f
q=Math.max(q,H.y(b.ia(k)))}n=a2.d
n.toString
...
D.pj.prototype={
Cw:function(b9,c0,c1,c2,c3,c4,c5,c6){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5=this,b6=b9.a,b7=b9.b,b8=b6/b7
b5.r=3.141592653589793*Q.pB(b8,0.5,2.5,50,5)/180
b5.x=Q.pB(b8,0.5,2.5,50,150)
s=c0.length
r=new Array(s)
...
a5=b5.f[p]
a5.toString
d[m]=0+(a4-0)/(a5-0)*(b5.x-0)}b5.d[p]=P.f1()
b5.e[p]=P.f1()
b5.d[p].bA(0,j,b7)
b5.e[p].bA(0,j,b7)
...
b5.e[p].bb(0)}r=t.oz
b5.y=H.b([],r)
for(p=0;p<c0.length;++p){q=A.GM(P.k7(255,255,255,255),12)
b4=new U.ek(new Q.ht(c0[p].a.toUpperCase(),q),C.dH,C.x)
b4.jx(0)
b5.y.push(b4)}b5.z=H.b([],r)
for(p=0;p<c1.length;++p){r=A.GM(P.k7(255,255,255,255),10)
b4=new U.ek(new Q.ht(c1[p].b.toUpperCase(),r),C.dH,C.x)
b4.jx(0)
...
r(P.cF,[P.iJ,P.p6])
q(P.tE,P.mT)
r(W.w,[W.z,W.xz,W.oL,W.zY,W.kI,W.Cb,W.pD,W.l3,W.l5,W.pT,W.Em,W.dA,W.cW,W.mD,W.G8,W.d1,W.cn,W.mJ,W.Hd,W.hA,P.yJ,P.xi,P.hY])
r(W.z,[W.N,W.d9,W.dS,W.jn])
r(W.N,[W.B,P.C])
